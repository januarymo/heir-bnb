...
Palace.create!(
  ...
  photo: "https://res.cloudinary.com/dg1vldahp/image/upload/v1582677612/castillo-de-chapultepec-cdmx_fghnwc.jpg",
  user: brandon
  )
...
Palace.create!(
  ...
  price: 50000,
  location: "Bel Air",
  photo: "https://res.cloudinary.com/dg1vldahp/image/upload/v1582678737/jorge-martinez-instagram-jmartinezz9-1iBEXJOHCsM-unsplash_d4zkes.jpg",
  user: brandon
  )
...
Palace.create!(
  ...
  price: 250000,
  location: "London",
  photo: "https://res.cloudinary.com/dg1vldahp/image/upload/v1582679941/debbie-fan-KVmKINrtLVk-unsplash_vwhnsp.jpg",
  user: brandon
  )
...
Palace.create!(
  ...
  price: 300000,
  location: "The Moon",
  photo: "https://res.cloudinary.com/dg1vldahp/image/upload/v1582680343/sailor_moon_zkjis5.jpg",
  user: brandon
  )
